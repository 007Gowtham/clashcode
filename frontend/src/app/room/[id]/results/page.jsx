...
export default function LeaderboardPage() {
 ...
 <span className="text-xs font-bold tracking-[0.15em] text-slate-500 uppercase  group-hover:text-slate-700">DSA Multiplayer Arena</span>
 </div>

 <TypographyH1 className="text-5xl md:text-6xl font-bold tracking-tight text-slate-900 mb-4">
 ...
 <span className="text-xs font-bold text-emerald-700 bg-emerald-50 border border-emerald-200 px-3 py-1.5 rounded-lg  uppercase tracking-wide cursor-pointer" onClick={fetchLeaderboard}>
 ↻ Live Updates
 </span>
 </div>
 ...
 <TableHead className="w-[80px] font-medium text-slate-500 text-sm py-4 px-6">Rank</TableHead>
 <TableHead className="w-[35%] font-medium text-slate-500 text-sm py-4">Team Name</TableHead>
 <TableHead className="w-[15%] font-medium text-slate-500 text-sm py-4">Members</TableHead>
 <TableHead className="w-[20%] font-medium text-slate-500 text-sm py-4">Problems Solved</TableHead>
 <TableHead className="w-[15%] text-right font-medium text-slate-500 text-sm py-4 px-6">Score</TableHead>
 </TableRow>
 </TableHeader>
 <TableBody>
 ...
 >
 <TableCell className="text-slate-900 text-lg font-bold py-5 px-6 ">
 ...
 <span className=" font-bold text-slate-700">{team.problemsSolved}</span>
 </div>
 </TableCell>
 <TableCell className="text-right text-slate-900 text-xl font-bold py-5 px-6 ">
 ...
 <TableHead className="font-medium text-slate-500 text-sm">Name</TableHead>
 <TableHead className="font-medium text-slate-500 text-sm">Role</TableHead>
 <TableHead className="text-right font-medium text-slate-500 text-sm">Score</TableHead>
 </TableRow>
 </TableHeader>
 <TableBody>
 ...
 <TableCell className="text-right font-medium text-slate-900 text-base ">{member.score || 0}</TableCell>
 </TableRow>
 ))}
 </TableBody>
 </Table>
