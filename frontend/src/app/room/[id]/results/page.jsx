...
export default function LeaderboardPage() {
    ...
    return (
        <div className="bg-white text-slate-900 min-h-screen flex flex-col relative antialiased font-sans overflow-hidden">
            ...
            <main className="relative z-10 w-full max-w-6xl mx-auto px-6 pt-24 pb-24 flex flex-col items-center">

                {/* Top Action Buttons - fixed top-left / top-right */}
                <div className="fixed left-6 top-6 flex items-center gap-3 z-50">
                    <button
                        onClick={() => router.push(room?.status === 'ENDED' ? '/rooms' : `/room/${roomId}/battle`)}
                        className="inline-flex items-center gap-2 text-sm font-medium text-slate-700 hover:text-slate-900 bg-white/90 px-3 py-1.5 rounded-full border border-slate-200 shadow-sm backdrop-blur transition-all active:scale-95"
                    >
                        <ArrowLeft className="w-4 h-4" />
                        <span>{room?.status === 'ENDED' ? 'Back to Lobby' : 'Back to Battle'}</span>
                    </button>
                ...
                <div className="fixed right-6 top-6 z-50">
                    <button
                        ...
                        className="inline-flex items-center gap-2 text-sm font-medium text-slate-700 hover:text-slate-900 bg-white/90 px-3 py-1.5 rounded-full border border-slate-200 shadow-sm backdrop-blur"
                    >
                        Leave Room
                    </button>
                </div>
                ...
                <RoomHeader
                    ...
                    titleClassName="font-[family-name:var(--font-mono)]"
                />
                ...
                <div className="w-full max-w-6xl mx-auto mb-12 text-center sm:text-left relative">
                    ...
                    <TypographyH1 className="text-5xl md:text-6xl font-black tracking-tight text-slate-900 mb-4">
                        Where Coders Rise <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-500">and Legends Stay.</span>
                    </TypographyH1>
                ...
                {topTeams.length > 0 && (
                    <div className="w-full max-w-5xl mx-auto mb-16 grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                        {/* Rank 2 (Left) */}
                        <div className="group bg-white rounded-[2rem] border border-slate-200/60 shadow-[0_8px_30px_-12px_rgba(0,0,0,0.05)] p-8 flex flex-col items-center text-center order-2 md:order-1 transition-all duration-300 hover:-translate-y-3 hover:-rotate-2">
                            <div className="w-20 h-20 mb-6 bg-slate-50 rounded-[1.25rem] shadow-sm border border-slate-100 flex items-center justify-center transition-colors duration-300 group-hover:bg-emerald-100 group-hover:border-emerald-200">
                                <Medal strokeWidth={1.5} className="w-9 h-9 text-slate-400 transition-colors duration-300 group-hover:text-emerald-600" />
                            </div>
                            <h3 className="text-3xl font-bold text-slate-900 mb-1 tracking-tight transition-colors duration-300 group-hover:text-emerald-800">
                                {topTeams[1]?.score || 0} <span className="text-lg text-slate-400 font-normal group-hover:text-emerald-700">pts</span>
                            </h3>
                            <p className="text-slate-500 font-semibold mb-3 transition-colors duration-300 group-hover:text-emerald-700">2nd Place</p>
                            <TypographyH3 className="text-lg text-slate-700 truncate w-full transition-colors duration-300 group-hover:text-emerald-800">
                                {topTeams[1]?.name || '-'}
                            </TypographyH3>
                        </div>

                        {/* Rank 1 (Center - Elevated) */}
                        <div className="group bg-white rounded-[2rem] border border-emerald-100 shadow-[0_20px_40px_-12px_rgba(16,185,129,0.15)] p-8 flex flex-col items-center text-center order-1 md:order-2 relative z-10 transform md:-translate-y-8 min-h-[320px] justify-center transition-all duration-300 hover:-translate-y-4 hover:-rotate-2">
                            <div className="w-24 h-24 mb-6 bg-slate-50 rounded-[1.5rem] border border-slate-100 shadow-[0_8px_20px_-4px_rgba(15,23,42,0.25)] flex items-center justify-center transition-all duration-300 group-hover:-rotate-6 group-hover:scale-105 group-hover:bg-emerald-100 group-hover:border-emerald-200 group-hover:shadow-[0_12px_30px_-10px_rgba(16,185,129,0.4)]">
                                <Trophy strokeWidth={1.5} className="w-10 h-10 text-amber-400 transition-colors duration-300 group-hover:text-emerald-600" />
                            </div>

                            <h3 className="text-4xl font-extrabold text-slate-900 mb-2 tracking-tight transition-colors duration-300 group-hover:text-emerald-800">
                                {topTeams[0]?.score || 0} <span className="text-xl text-slate-400 font-normal group-hover:text-emerald-700">pts</span>
                            </h3>
                            <p className="text-emerald-600 font-bold mb-4 uppercase tracking-wider text-sm transition-colors duration-300 group-hover:text-emerald-700">Winner</p>
                            <TypographyH2 className="text-2xl text-slate-900 truncate w-full border-none pb-0 tracking-tight transition-colors duration-300 group-hover:text-emerald-900">
                                {topTeams[0]?.name || '-'}
                            </TypographyH2>
                        </div>

                        {/* Rank 3 (Right) */}
                        <div className="group bg-white rounded-[2rem] border border-slate-200/60 shadow-[0_8px_30px_-12px_rgba(0,0,0,0.05)] p-8 flex flex-col items-center text-center order-3 transition-all duration-300 hover:-translate-y-3 hover:-rotate-2">
                            <div className="w-20 h-20 mb-6 bg-slate-50 rounded-[1.25rem] shadow-sm border border-slate-100 flex items-center justify-center transition-colors duration-300 group-hover:bg-emerald-100 group-hover:border-emerald-200">
                                <Medal strokeWidth={1.5} className="w-9 h-9 text-amber-700 transition-colors duration-300 group-hover:text-emerald-600" />
                            </div>
                            <h3 className="text-3xl font-bold text-slate-900 mb-1 tracking-tight transition-colors duration-300 group-hover:text-emerald-800">
                                {topTeams[2]?.score || 0} <span className="text-lg text-slate-400 font-normal group-hover:text-emerald-700">pts</span>
                            </h3>
                            <p className="text-slate-500 font-semibold mb-3 transition-colors duration-300 group-hover:text-emerald-700">3rd Place</p>
                            <TypographyH3 className="text-lg text-slate-700 truncate w-full transition-colors duration-300 group-hover:text-emerald-800">
                                {topTeams[2]?.name || '-'}
                            </TypographyH3>
                        </div>
                ...
                <div className="w-full max-w-6xl mx-auto">
                    <div className="bg-white border border-slate-200/60 rounded-2xl overflow-hidden shadow-[0_8px_30px_-12px_rgba(0,0,0,0.08)]">
                        ...
                        <div className="px-8 py-6 border-b border-slate-200/60 flex justify-between items-center bg-gradient-to-r from-slate-50 to-white">
                            <TypographyH3 className="text-slate-900 border-none pb-0 flex items-center gap-2 tracking-tight">
                                <Trophy className="w-5 h-5 text-emerald-600" />
                                Full Rankings
                            </TypographyH3>
                            <span className="text-xs font-bold text-emerald-700 bg-emerald-50 border border-emerald-200 px-3 py-1.5 rounded-lg font-mono uppercase tracking-wide cursor-pointer" onClick={fetchLeaderboard}>
                                ↻ Live Updates
                            </span>
                        </div>
                            ...
                            <Table className='w-full'>
                                <TableHeader>
                                    <TableRow className="bg-slate-100/50 hover:bg-slate-100/50 border-b border-slate-200/60">
                                        <TableHead className="w-[80px] font-bold text-slate-900 text-sm uppercase tracking-wider py-4 px-6">Rank</TableHead>
                                        <TableHead className="w-[35%] font-bold text-slate-900 text-sm uppercase tracking-wider py-4">Team Name</TableHead>
                                        <TableHead className="w-[15%] font-bold text-slate-900 text-sm uppercase tracking-wider py-4">Members</TableHead>
                                        <TableHead className="w-[20%] font-bold text-slate-900 text-sm uppercase tracking-wider py-4">Problems Solved</TableHead>
                                        <TableHead className="w-[15%] text-right font-bold text-slate-900 text-sm uppercase tracking-wider py-4 px-6">Score</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                    {remainingTeams.map((team, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <TableCell className="text-slate-900 text-lg font-bold py-5 px-6 font-mono">
                                                ...
                                                <TableCell className="text-slate-900 text-lg font-semibold py-5">
                                                    {team.name}
                                                </TableCell>
                                                ...
                                                <TableCell className="text-slate-600 text-base py-5">
                                                    <div className="flex items-center gap-2 px-10">
                                                        ...
                                                        <span className="font-mono font-bold text-slate-700">{team.problemsSolved}</span>
                                                    </div>
                                                </TableCell>
                                                <TableCell className="text-right text-slate-900 text-xl font-bold py-5 px-6 font-mono">
                        ...
                        <div className="mt-8 space-y-8">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                <div className="bg-slate-50 rounded-xl p-4 text-center border border-slate-100">
                                    ...
                                    <p className="text-2xl font-bold text-slate-900 font-mono">{selectedTeam?.members?.length || 1}</p>
                                </div>
                                <div className="bg-slate-50 rounded-xl p-4 text-center border border-slate-100">
                                    <p className="text-xs text-slate-500 font-bold uppercase tracking-wider mb-1">Solved</p>
                                    <p className="text-2xl font-bold text-slate-900 font-mono">{selectedTeam?.problemsSolved || 0}</p>
                                </div>
                                <div className="bg-slate-50 rounded-xl p-4 text-center border border-slate-100">
                                    <p className="text-xs text-slate-500 font-bold uppercase tracking-wider mb-1">Score</p>
                                    <p className="text-2xl font-bold text-slate-900 font-mono">{selectedTeam?.score || 0}</p>
                                </div>
                            </div>
                                        ...
                                        <TableBody>
                                            {selectedTeam?.members?.map((member) => (
                                                <TableRow key={member.id}>
                                                    ...
                                                    <TableCell className="text-right font-medium text-slate-900 text-base font-mono">{member.score || 0}</TableCell>
                                                </TableRow>
                                            ))}
                                        </TableBody>
                                    </Table>
