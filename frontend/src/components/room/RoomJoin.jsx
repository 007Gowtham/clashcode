...
const RoomJoin = ({ onJoin, isLoading = false }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 py-4 font-[family-name:var(--font-inter)]">
      <div className="space-y-4">
        ...
        <div className="relative group">
          <Input
            ...
            maxLength={6}
            className="text-center tracking-[0.2em] text-lg font-bold text-slate-800 bg-white border-slate-200 focus:bg-white focus:border-blue-300 transition-all uppercase rounded-xl"
            required
          />
        </div>
