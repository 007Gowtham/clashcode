...
<<<<<<< HEAD
 ...
 <h3 className="text-4xl md:text-5xl font-black tracking-tight text-slate-900 mb-2 ">
...
=======
  ...
  />
  <div className="absolute inset-0 bg-gradient-to-t from-[#f5f7f9] dark:from-[#111111] via-transparent to-transparent"></div>
  </div>

  {/* Catchy Connect Text - Outside Map Container */}
  <div className="absolute top-[450px] left-0 right-0 text-center flex flex-col items-center justify-center pointer-events-none z-0 px-4">
  <div className="inline-flex items-center gap-2 py-1.5 px-3 rounded-full bg-slate-50 dark:bg-[#1e1e1e] border border-slate-200/60 dark:border-[#2d2d2d] mb-4 shadow-sm backdrop-blur-sm">
  <span className="relative flex h-2 w-2">
  <span className="absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
  <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
  </span>
  <span className="text-xs font-bold tracking-[0.15em] text-slate-500 dark:text-[#8c8c8c] uppercase font-mono">Global Battleground</span>
  </div>

  <h3 className="text-4xl md:text-5xl font-black tracking-tight text-slate-900 dark:text-white mb-2 ">
  The <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600 dark:from-[#ffa116] dark:to-[#ffa116]">Arena Awaits.</span>
  </h3>
