            ...
            <div className="flex items-center gap-4 mb-6 w-full">
                ...
                {isPrivate && (
                    <div className="bg-slate-100 px-3 py-1 rounded-full flex items-center gap-1.5 shrink-0">
                        ...
                        <span className="text-xs font-medium text-slate-600 font-[family-name:var(--font-inter)]">Private</span>
                    </div>
                )}
            </div>
            ...
            <div className="w-full mb-6">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 w-full border-t border-b border-gray-100 py-4">
                    <div className="flex flex-col gap-0.5">
                        <span className="text-xs text-slate-500 font-medium uppercase tracking-wider font-[family-name:var(--font-inter)]">Teams</span>
                        <span className="text-lg font-semibold text-slate-900 font-[family-name:var(--font-mono)]">{room.teams?.length || 0}</span>
                    </div>

                    <div className="flex flex-col gap-0.5 pl-4 border-l border-gray-200">
                        <span className="text-xs text-slate-500 font-medium uppercase tracking-wider font-[family-name:var(--font-inter)]">Time Limit</span>
                        <span className="text-lg font-semibold text-slate-900 font-[family-name:var(--font-mono)]">{room.timeLimitMinutes || 30}m</span>
                    </div>
